/**
 * 에티오피아 선교 아카이브 - 실시간 구글 지도(Google Maps) 대화형 연동 엔진 v35000
 * 영문 구글 지도 지명 연동 (English Region Names for Map Pins)
 */

const ETHIOPIA_REGIONS = [
  { id: "아디스아바바", name: "아디스아바바 (Addis Ababa)", nameEn: "Addis Ababa", lat: 9.0300, lng: 38.7400, isCapital: true },
  { id: "비쇼프투", name: "비쇼프투 (Bishoftu)", nameEn: "Bishoftu", lat: 8.7500, lng: 38.9833 },
  { id: "아다마", name: "아다마 (Adama / Nazret)", nameEn: "Adama", lat: 8.5400, lng: 39.2700 },
  { id: "세베타", name: "세베타 (Sebeta)", nameEn: "Sebeta", lat: 8.9167, lng: 38.6167 },
  { id: "모조", name: "모조 (Mojo)", nameEn: "Mojo", lat: 8.5900, lng: 39.1200 },
  { id: "네켐테", name: "네켐테 (Nekemte)", nameEn: "Nekemte", lat: 9.0833, lng: 36.5500 },
  { id: "하와사", name: "하와사 (Hawassa)", nameEn: "Hawassa", lat: 7.0620, lng: 38.4763 },
  { id: "아르바민치", name: "아르바 민치 (Arba Minch)", nameEn: "Arba Minch", lat: 6.0333, lng: 37.5500 },
  { id: "알렘테나", name: "알렘 테나 (Alem Tena)", nameEn: "Alem Tena", lat: 8.3000, lng: 38.9500 },
  { id: "아사사", name: "아사사 / 아르시 (Asasa)", nameEn: "Asasa", lat: 7.1000, lng: 39.2000 },
  { id: "바히르다르", name: "바히르다르 (Bahir Dar)", nameEn: "Bahir Dar", lat: 11.5936, lng: 37.3908 },
  { id: "디레다와", name: "디레다와 (Dire Dawa)", nameEn: "Dire Dawa", lat: 9.5931, lng: 41.8661 },
  { id: "곤다르", name: "곤다르 (Gondar)", nameEn: "Gondar", lat: 12.6000, lng: 37.4667 },
  { id: "지마", name: "지마 (Jimma)", nameEn: "Jimma", lat: 7.6667, lng: 36.8333 },
  { id: "기타", name: "기타 지역", nameEn: "Others", lat: 8.8000, lng: 38.8000 }
];
